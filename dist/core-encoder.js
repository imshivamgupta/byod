(function (b, k) {
  ...
  var qt = (b, k, p) =>
    k in b
      ? Yt(b, k, { enumerable: !0, configurable: !0, writable: !0, value: p })
      : (b[k] = p);
  var O = (b, k, p) => (qt(b, typeof k != "symbol" ? k + "" : k, p), p);
  let k = 0;
  function p() {
    if (!(k > 100)) {
      if (k === 100)
  ...
  class ve {
    constructor(e, { parent: t, vertexShader: s, fragmentShader: i } = {}) {
      ...
      (this.renderer = e),
        (this.gl = this.renderer.gl),
        (this.parent = t),
        (this.defaultVsCode = this.parent.type === "Plane" ? Je : et),
        (this.defaultFsCode = this.parent.type === "Plane" ? Ke : tt),
        s
          ? (this.vsCode = s)
          : (!this.renderer.production &&
...
`,
    ...
    createUniforms(e) {
      (this.uniformsManager = new Ze(this.renderer, this.program, e)),
        this.setUniforms();
    }
    setUniforms() {
  ...
  class H {
    ...
    composeFromOrigin(e, t, s, i) {
      ...
      return (
        ...
        (r[10] = He),
        (r[11] = 0),
        (r[12] = e.x + C - (I * C + q * E + We * M)),
        (r[13] = e.y + E - (j * C + A * E + Ne * M)),
        (r[14] = e.z + M - (Y * C + Be * E + He * M)),
        (r[15] = 1),
        this
      );
    }
  ...
  class Z {
    constructor(
      ...
      if (
        ...
        (this._textureMatrix = { matrix: new H(), isActive: !1 }),
...
gl.LINEAR filtering will be used instead`
    ...
    _getSizes() {
      ...
      const e = this._parent.scale
          ? fe.set(this._parent.scale.x, this._parent.scale.y)
          : fe.set(1, 1),
    ...
    setScale(e) {
      ...
      e.sanitizeNaNValuesWith(this.scale).max(fe.set(0.001, 0.001)),
    ...
    _updateTextureMatrix(e) {
      ...
      (t.x /= this.scale.x),
        (t.y /= this.scale.y),
        (this._textureMatrix.matrix = rt.setFromArray([
          t.x,
          0,
          0,
          0,
  ...
  class ht {
    constructor(
      ...
      (this._canDraw = !1),
        ...
        (o = parseInt(o)),
        (l = parseInt(l)),
        (this._geometry = new st(this.renderer, { width: o, height: l })),
    ...
    _initMesh() {
      (this.uuid = ue()),
        (this.loader = new nt(this.renderer, this, {
          sourcesLoaded: 0,
          initSourcesToLoad: 0,
          complete: !1,
          onComplete: () => {
    ...
    createTexture(e = {}) {
      const t = new Z(this.renderer, Object.assign(e, this._texturesOptions));
...
`,
  ...
  class lt extends ht {
    ...
    mouseToPlaneCoords(e) {
      const t = this.scale ? this.scale : ot.set(1, 1),
        s = Pe.set(
  ...
  class dt {
    constructor({
      ...
      (this.position = new T()),
        ...
        (this.worldMatrix = new H()),
        (this.viewMatrix = new H()),
  ...
  class Re extends lt {
    ...
    _initTransformValues() {
      (this.rotation = new T()),
        ...
        (this.quaternion = new ne()),
        (this.relativeTranslation = new T()),
        this.relativeTranslation.onChange(() => this._setTranslation()),
        (this._translation = new T()),
        (this.scale = new T(1)),
        this.scale.onChange(() => {
          (this.scale.z = 1), this._applyScale();
        }),
        (this.transformOrigin = new T(0.5, 0.5, 0)),
    ...
    _setWorldTransformOrigin() {
      this._boundingRect.world.transformOrigin = new T(
    ...
    setScale(e) {
      ...
      e.sanitizeNaNValuesWith(this.scale).max(ct.set(0.001, 0.001)),
    ...
    mouseToPlaneCoords(e) {
      if (
        (Te.setAxisOrder(this.quaternion.axisOrder),
        Te.equals(this.quaternion) && xt.equals(this.transformOrigin))
      )
  ...
  class Tt extends Re {
    constructor(
      ...
      this.renderer.scene.removePlane(this),
        ...
        this.renderer.scene.addPlane(this),
        (this.readPass = new pe(e, {
          depth: !1,
          clear: !1,
          texturesOptions: g,
        })),
        (this.writePass = new pe(e, {
          depth: !1,
          clear: !1,
          texturesOptions: g,
        })),
  ...
  typeof document.hidden < "u"
    ? ((he = "hidden"), (te = "visibilitychange"))
    : typeof document.msHidden < "u"
    ? ((he = "msHidden"), (te = "msvisibilitychange"))
    : typeof document.webkitHidden < "u" &&
      ((he = "webkitHidden"), (te = "webkitvisibilitychange"));
  function le(n, e) {
    let t;
    return function (...s) {
      clearTimeout(t),
  ...
  function St(n) {
    ...
    let s = n.coords.map(([i, r]) =>
      Rt(e.center.x, e.center.y, i, r, -n.rotation * 360)
    );
    return (
  ...
  function se(n) {
    return ["mouse", "waterRipple"].includes(n);
  }
  function ee(n) {
    const e =
      ("trackMouse" in n && n.trackMouse > 0) ||
      ("axisTilt" in n && n.axisTilt > 0) ||
      ("trackMouseMove" in n && n.trackMouseMove > 0);
    let t =
        n.states &&
        [...n.states.appear, ...n.states.scroll, ...n.states.hover].length,
      s = n.layerType === "effect" && (n.animating || se(n.type));
    return e || s || t;
  }
  function Mt(n, e, t) {
    const s = [];
    return (
      n.forEach((i) => {
        switch (i.layerType) {
          case "text":
            s.push(new Ot(i, e, null, t).unpackage());
            break;
          case "image":
            s.push(new Dt(i, e, t).unpackage());
            break;
          case "fill":
            s.push(new Le(i, e, t).unpackage());
            break;
          case "shape":
            s.push(new kt(i, e, t).unpackage());
            break;
          case "effect":
            s.push(new Le(i, e, t).unpackage());
            break;
  ...
  function At(n, e) {
    const s =
        K([e.offsetWidth || n.width, e.offsetHeight || n.height])[0] /
        e.offsetWidth,
  ...
  function Fe() {
    b.scenes.forEach((n, e) => {
      document.body.contains(n.element) ||
        (n.curtain.dispose(), b.scenes.splice(e, 1));
    });
  }
  function _e() {
    cancelAnimationFrame(ie);
    const n = b.scenes.filter((t) => t.getAnimatingEffects().length > 0),
      e = (t) => {
        let s = !1;
        n.forEach((i) => {
          ...
          (Ee = X),
          s
            ? (Vt(), (ie = requestAnimationFrame(e)))
            : cancelAnimationFrame(ie);
      };
    n.length && (ie = requestAnimationFrame(e));
  }
  function Ct(n, e) {
  ...
  function Q(n, e) {
    ...
    return (
      n.type === "Vec2"
        ? ((t = new L(n._x, n._y)), e && (t.y = 1 - t.y))
        : n.type === "Vec3"
        ? (t = new T(n._x, n._y, n._z))
        : (t = n),
      t
    );
  }
  class Ft {
    constructor({ prop: e, value: t, transition: s, uniformData: i }) {
      (this.prop = e),
        ...
        (this.uniformData = i),
        (this.value = Q(t, this.prop === "pos"));
    }
    initializeState(e, t) {
      if (
        (t !== void 0 &&
          (typeof t == "object"
            ? ((this.endVal = Q(t, this.prop === "pos")),
              (this.startVal = Q(this.value, this.prop === "pos")))
            : (this.endVal = t)),
        e)
      ) {
        if (typeof this.value == "object") {
          ...
          this.value.type === "Vec2"
            ...
            : this.value.type === "Vec3" &&
              (r = new T(this.value._x, this.value._y, this.value._z)),
            (e.value = r);
    ...
    updateEffect(e) {
      ...
      if (h > 0 && h <= 1) {
        let l = r(h);
        t
          ? ((i.value.x = F(o.x, this.endVal.x, l)),
            this.prop === "pos"
              ? (i.value.y = F(1 - o.y, this.endVal.y, l))
              : (i.value.y = F(o.y, this.endVal.y, l)),
            o.type === "Vec3" && (i.value.z = F(o.z, this.endVal.z, l)))
          : (i.value = F(o, this.endVal, l));
      } else t ? (i.value = Q(this.value, this.prop === "pos")) : (i.value = this.value);
      return (
  ...
  class It {
    ...
    updateEffect(e, t, { top: s, height: i, isFixed: r }) {
      if (t === void 0) return !1;
      this.startVal ||
        (typeof this.value == "object"
          ? (this.startVal = Q(t, this.prop === "pos"))
          : (this.startVal = t));
      const a = typeof this.value == "object",
        h = e.uniforms[this.prop];
      if ((r && (s -= X), this.mode === "scrollIntoView")) {
        const o = s + X - B * this.offset,
          l = o + (B + i) * this.range;
        let d = (X - o) / (l - o),
          c = this.value;
        if (!h) return !1;
        let f = Math.max(0, Math.min(1, d));
        return (
          this.lastTick !== void 0 &&
            (f = J(f, this.lastTick, this.momentum * 2)),
          this.lastTick !== void 0 && Math.abs(this.lastTick - f) < 0.001
            ? !1
            : (a
                ? ((h.value.x = F(this.startVal.x, c.x, f)),
                  this.prop === "pos"
                    ? (h.value.y = F(1 - this.startVal.y, c.y, f))
                    : (h.value.y = F(this.startVal.y, c.y, f)),
                  this.startVal.type === "Vec3" &&
                    (h.value.z = F(this.startVal.z, c.z, f)))
                : (h.value = F(this.startVal, c, f)),
              (this.lastTick = f),
              !0)
        );
        ...
        if (
          ...
          return !1;
        a
          ? ((h.value.x = F(t.x, l.x, o)),
            (h.value.y = F(t.y, l.y, o)),
            t.type === "Vec3" && (h.value.z = F(t.z, l.z, o)))
          : (h.value = F(t, l, o)),
  ...
  class zt {
    ...
    updateEffect(e, t, s) {
      ...
      (this.rawProgress = Math.max(0, Math.min(1, d))),
        (this.progress = Ie(this.transition.ease)(this.rawProgress));
      const c = () => {
        i
          ? ((o.value.x = F(t.x, this.value.x, this.progress)),
            this.prop === "pos"
              ? (o.value.y = F(t.y, 1 - this.value.y, this.progress))
              : (o.value.y = F(t.y, this.value.y, this.progress)),
            this.value.type === "Vec3" &&
              (o.value.z = F(t.z, this.value.z, this.progress)))
          : (o.value = F(t, this.value, this.progress));
      };
      return o
        ? !s && this.progress === 0
      ...
      n.forEach((e) => {
        ...
        for (let i in e.props)
          ((t = e.props[i]) == null ? void 0 : t.type) === "Vec2"
            ? (e.props[i] = new L(e.props[i]._x, e.props[i]._y))
            : ((s = e.props[i]) == null ? void 0 : s.type) === "Vec3"
            ? (e.props[i] = new T(e.props[i]._x, e.props[i]._y, e.props[i]._z))
            : typeof e.props[i] == "object" && (e.props[i] = W(e.props[i]));
      }),
      n
    );
  }
  class ze {
    constructor(e, t) {
      ...
      (this.visible = e.visible !== void 0 ? e.visible : !e.hidden || !0),
        ...
        (this.breakpoints = Lt(e.breakpoints || [])),
        (this.local.sceneId = t),
        (this.local.id = Ae());
    }
    state() {
      return (
        b.scenes.find((e) => e.id === this.local.sceneId) || this.initOptions
      );
    }
    getIndex() {
      return this.state()
    ...
    getPlane() {
      return this.state().curtain.planes.find(
        (e) => e.type !== "PingPongPlane" && e.userData.id === this.local.id
      );
    }
    getPlanes() {
  ...
  let xe = class extends ze {
    ...
    createLocalCanvas() {
      ...
      const a =
          K([t.element.offsetWidth, t.element.offsetHeight])[0] /
  ...
  class kt extends xe {
    ...
    unpackage() {
      return (
        (this.fill = W(this.fill)),
        (this.stroke = W(this.stroke)),
        (this.coords = W(this.coords)),
        this.coords.length &&
          (!this.width || !this.height) &&
          ((this.width = [this.coords[0][0], this.coords[1][0]]),
          (this.height = [this.coords[1][1], this.coords[2][1]])),
        (this.effects = W(this.effects)),
        this.render(),
        this
      );
    }
    render() {
      ...
      if (this.fitToCanvas) {
        const s = this.state(),
          r =
            K([s.element.offsetWidth, s.element.offsetHeight])[0] /
      ...
      if ((this.local.ctx.beginPath(), this.type === "rectangle")) {
        ...
        if (t.length) {
          ...
          for (let o = 0; o < t.length; o++) {
            const [l, d] = t[o],
              ...
              [g, m] = r(i, 0, u);
            let w = h[o];
            this.local.ctx.lineTo(l - g * w, d - m * w),
              this.local.ctx.arcTo(l, d, c, f, i);
          }
        ...
        if (t.length >= 2) {
          ...
          for (let u = 0; u < s; u++) {
            ...
            ([w, R] = l(w, R, d, o, h)),
              u === 0
                ? this.local.ctx.moveTo(w, R)
                : this.local.ctx.lineTo(w, R);
          }
          this.local.ctx.closePath();
        }
      }
      (this.local.ctx.fillStyle = Se(this.local.ctx, this, t)),
        ...
        (this.states = {
          appear:
            t.states && t.states.appear
              ? t.states.appear.map((r) => new Ft(r))
              : [],
          scroll:
            t.states && t.states.scroll
              ? t.states.scroll.map((r) => new It(r))
              : [],
          hover:
            t.states && t.states.hover
              ? t.states.hover.map((r) => new zt(r))
              : [],
        });
      ...
      for (let t in this)
        this[t] &&
          ...
          (this[t].type === "Vec2"
            ...
            : this[t].type === "Vec3" &&
              (this[t] = new T(this[t]._x, this[t]._y, this[t]._z)));
      return this;
    }
    getParent() {
      return this.state()
        ...
        t.addEventListener(
          ...
          () => {
            (this.local.img = t),
              ...
              this.getPlane()
                ? this.getPlane()
                    .textures.filter((s) => s.sourceType === "canvas")
                    .forEach((s) => {
  ...
  class Ot extends xe {
    ...
    unpackage() {
      return (
        (this.fill = W(this.fill)),
        (this.highlight = W(this.highlight)),
        (this.coords = W(this.coords)),
        (this.effects = W(this.effects)),
        this
      );
    ...
    loadFont() {
      ...
      document.fonts.add(h),
        h
          ...
          .catch((o) => {
            console.error("Font loading error:", o);
          });
    }
    handleFontLoaded() {
      (this.local.loaded = !0),
    ...
    render() {
      ...
      (this.local.textBoxPos = { x: s, y: i }),
        ...
        (this.local.ctx.font = `${d} ${c} ${o}px/${l}px ${this.fontFamily}, -apple-system, BlinkMacSystemFont, Helvetica, Arial`),
        this.isSafari ||
      ...
      (a = Math.max(a, f)),
        ...
        (this.local.ctx.fillStyle = Se(this.local.ctx, this, this.coords));
      const u = (_, x, y, v, P, S, D) => {
          let C = x
              .split("")
              .reduce(
                (M, I, j) =>
                  M + _.measureText(I).width + (j < x.length - 1 ? P : 0),
                0
              ),
            E;
          if (
            (S === "center" ? (E = y + (D - C) / 2 - D / 2) : (E = y),
            S === "right")
          )
            for (let M = x.length - 1; M >= 0; M--) {
              const I = x[M];
              (E -= _.measureText(I).width),
                _.fillText(I, E, v),
                M > 0 && (E -= P);
            }
          else
            for (let M = 0; M < x.length; M++)
              _.fillText(x[M], E, v), (E += _.measureText(x[M]).width + P);
        },
        g = (_, x) => {
          let y = i + l * x + l / 2 + o / 3;
          this.isSafari
            ? u(this.local.ctx, _, s, y, this.letterSpacing, this.textAlign, a)
            : this.local.ctx.fillText(_, s, y);
        },
        m = this.textContent
...
`)
      ...
      const R = (_, x, y) =>
        x
          ...
          .reduce(
            (P, S, D) => (
              (P += _.measureText(S).width), D < x.length - 1 && (P += y), P
            ),
            0
          );
      for (let _ = 0; _ < w; _++) {
        ...
        for (let v = 0; v < y.length; v++) {
          ...
          if (
            (this.isSafari && this.letterSpacing
              ? R(this.local.ctx, S, this.letterSpacing)
              : this.local.ctx.measureText(S).width) > a ||
            P ===
              `
`
          ) {
            if (x !== "")
              (m[_] = x.trim()),
                v !== y.length - 1
                  ? (m.splice(_ + 1, 0, y.slice(v).join("")), w++)
                  : P !==
                      `
` && m.push(P);
            else {
              ...
              for (; C.length > 0; ) {
                ...
                for (
                  let I = 0;
                  I < C.length &&
                  (this.local.ctx.measureText(M + C[I]).width <= a || I == 0);
                  I++
                )
                  M += C[I];
                (C = C.slice(M.length)),
                  (m[E] = M.trim()),
                  C.length > 0 && (m.splice(E + 1, 0, C), E++, w++);
              }
  ...
  function ke() {
    document[he] ? cancelAnimationFrame(ie) : _e();
  }
  function de() {
    b.scenes.forEach((n) => {
      n.refresh();
  ...
  function De(n, e, t = 50) {
    const s = e || n.getBoundingClientRect(),
      i =
        (s.top >= -t && s.top <= B + t) ||
        (s.bottom >= -t && s.bottom <= B + t) ||
        (s.top <= 0 && s.bottom >= B),
      r =
        (s.left >= -t && s.left <= G + t) ||
        (s.right >= -t && s.right <= G + t) ||
        (s.left <= 0 && s.right >= G);
    return i && r;
  }
  function Ut() {
  ...
  function Oe(n) {
    ...
    e.length && !t.length && _e();
    const s = performance.now();
    (!me || s - me > 32) && Ut(),
      e.forEach((i) => {
        De(i.element, i.lastBbox, 50)
          ? ((i.isInView = !0),
            i.lazyLoad &&
              !i.initialized &&
              !i.initializing &&
          ...
          : (i.isInView = !1),
          i.isFixed || (i.mouse.movePos.y += oe / 2);
      });
  }
  function Vt() {
    b.scenes.forEach((n) => {
      ...
      if (
        n.isInView &&
        n.curtain.planes.find((s) => s.uniforms.mousePos) &&
        !(
          Ce() &&
          (t = (e = n.interactivity) == null ? void 0 : e.mouse) != null &&
          t.disableMobile
        )
      ) {
        ...
        let s = n.isFixed ? n.element.offsetTop : n.bbox.top + n.scrollY,
          i = n.isFixed ? n.element.offsetLeft : n.bbox.left;
        n.mouse.page.x > i &&
        n.mouse.page.y > s &&
        n.mouse.page.x < n.lastBbox.width + i &&
        n.mouse.page.y < n.lastBbox.height + s
    ...
    b.scenes
      ...
      .forEach((e) => {
        let t = e.bbox,
          ...
          i;
        n.targetTouches
          ? ((s = n.targetTouches[0].pageX), (i = n.targetTouches[0].pageY))
          : ((s = n.pageX), (i = n.pageY)),
          e.isFixed &&
            ((e.scrollY = 0),
            n.targetTouches
              ? (i = n.targetTouches[0].clientY)
              : (i = n.clientY));
  ...
  class Bt {
    constructor(e) {
      ...
      (this.id = e.id),
        ...
        (this.canvasWidth = e.width || e.element.offsetWidth || G),
        (this.canvasHeight = e.height || e.element.offsetHeight || B),
        (this.curtain = void 0),
    ...
    destroy() {
      this.element &&
        ...
        (b.scenes = b.scenes.filter((e) => e.id !== this.id)),
        b.scenes.length || ye();
    }
    resize() {
      this.setCanvasScale(),
    ...
    refresh() {
      (this.initialized = !1),
        this.curtain.planes.forEach(
          (e) => e.type !== "PingPongPlane" && e.remove()
        ),
        this.layers.forEach((e) => {
          var t, s;
          (t = e.states) == null || t.scroll.forEach((i) => i.resetState()),
            (s = e.states) == null ||
              s.appear.forEach((i) => (i.disabled = !0)),
        ...
        requestAnimationFrame(() => {
          this.resize(),
            (this.scrollY = X),
            this.isInView && this.initializePlanes();
        });
    }
    updateMouseTrail() {
      Me &&
    ...
    getAnimatingEffects() {
      return this.layers.filter((e) => ee(e) && e.visible);
    }
    createCurtains() {
      (this.curtain = new Qe({
      ...
      if (s) {
        let i = s.parentLayer ? s.getParent() : null,
          ...
          a =
            ...
            i.effects &&
            i.effects.length &&
            i.getChildEffectItems().filter((h) => ee(h)).length;
        for (; s && !ee(s) && !r && !a; )
          t++,
            (s = e[t]),
            s &&
    ...
    getPlaneParams(e, t) {
      ...
      if (
        ...
        e.states &&
          [...e.states.appear, ...e.states.scroll, ...e.states.hover].forEach(
            (d) => {
              i[d.prop] ||
                (d.uniformData &&
                  ((i[d.prop] = d.uniformData), (i[d.prop].value = d.value)));
            }
          ),
        ...
        for (let d in e.data.uniforms) {
          ...
          (i[d] = e.data.uniforms[d]),
            ((o = c.value) == null ? void 0 : o.type) === "Vec3"
              ? (i[d].value = new T(c.value._x, c.value._y, c.value._z))
              : ((l = c.value) == null ? void 0 : l.type) === "Vec2"
              ? (i[d].value = new L(c.value._x, c.value._y))
              : typeof c.value == "object" && (i[d].value = W(c.value));
        }
    ...
    createPlane(e, t, s) {
      ...
      e.isElement
        ...
        (i.watchScroll = !1);
      let r =
          (((o = e.data) == null ? void 0 : o.downSample) && !s) ||
          (s == null ? void 0 : s.downSample),
        a = this.scale * 0.5;
      r && this.curtain.renderer._renderingScale !== a
        ? ((this.curtain.renderer._renderingScale = a),
          this.curtain.renderer.setSize())
        : this.curtain.renderer._renderingScale !== this.scale &&
          ((this.curtain.renderer._renderingScale = this.scale),
          this.curtain.renderer.setSize());
      const h = new Re(this.curtain, this.curtain.container, i);
      if (!h) throw new Error("Unable to create plane");
      return (
        (h.textures.length = 0),
        (h.userData.id = e.local.id),
        (h.userData.layerType = e.layerType),
        (h.userData.type = e.type),
        (e.texture || ((l = e.data) != null && l.texture)) &&
          (h.userData.textureLoaded = !1),
        h.setRenderOrder(t),
        h
      );
    }
    createPingPongPlane(e, t, s) {
      let i = this.getPlaneParams(
        ...
        r = this.curtain.planes.find(
          (a) => a.type === "PingPongPlane" && a.userData.id === e.local.id
        );
      if (
        (r
          ? r.setRenderOrder(t)
          : ((r = new Tt(this.curtain, this.curtain.container, i)),
    ...
    handleEffectPlane(e, t, s) {
      ...
      a &&
        ...
        r
          ...
          : i.createTexture({ sampler: "uTexture" }),
        s.passIndex > 0 &&
          i &&
        ...
        [e.texture, (h = e.data) == null ? void 0 : h.texture]
          .filter((o) => (o == null ? void 0 : o.src))
          .forEach((o) => {
            i.loadImage(
              o.src,
              { sampler: o.sampler, premultipliedAlpha: !1 },
              (l) => {
    ...
    handleChildEffectPlane(e, t, s) {
      ...
      h &&
        ...
        i && a && (l || s.passIndex > 0)
          ...
          : i && e.isMask
          ? (d && c && i.addTexture(r.preloadedCanvasTexture),
            a &&
              i.createTexture({
                sampler: "uTexture",
                premultipliedAlpha: !0,
        ...
        [e.texture, (f = e.data) == null ? void 0 : f.texture]
          .filter((u) => (u == null ? void 0 : u.src))
          .forEach((u) => {
            i.loadImage(
              u.src,
              { sampler: u.sampler, premultipliedAlpha: !1 },
              (g) => {
                i.userData.textureLoaded = !0;
              }
            );
    ...
    createEffectPlanes(e, t) {
      ...
      s.passes && s.passes.length
        ? (this.createEffectPlane(e, t, {
          ...
          se(e.type) && this.createPingPongPlane(e, t, s.passes))
        : (this.createEffectPlane(e, t),
          se(e.type) && this.createPingPongPlane(e, t));
    }
    createTextures() {
    ...
    assignRenderTargetToPlane(e, t, s, i) {
      let r = this.getTextureParams(e, t, s),
        a = this.getRenderTargets()[t] || new pe(this.curtain, r);
    ...
    isNotReady(e) {
      ...
      return (
        (t.layerType === "image" && !t.local.loaded) ||
        (t.layerType === "text" && !t.local.loaded) ||
        ("textureLoaded" in e.userData && !e.userData.textureLoaded)
      );
    }
    checkIfReady(e) {
      const t = () => {
        ...
        for (let a = 0; a < r.length; a++)
          if (r[a].userData.isReady) {
            if (this.isNotReady(r[a])) {
              s = !0;
              break;
            }
          } else {
        ...
        i || s ? (i && this.curtain.render(), requestAnimationFrame(t)) : e();
      };
      t();
    }
      ...
      if (!e.userData.initialUniformsSet || !e.userData.isReady) {
        for (let r in e.uniforms)
          t.local.bpProps && r in t.local.bpProps
            ? r === "pos"
              ? ((e.uniforms[r].value.x = t.local.bpProps[r].x),
                (e.uniforms[r].value.y = 1 - t.local.bpProps[r].y))
              : (e.uniforms[r].value = t.local.bpProps[r])
    ...
    handleStateEffects(e, t) {
      if (
        ...
        !t.states ||
          ![...t.states.appear, ...t.states.scroll, ...t.states.hover].length)
      )
        return !1;
    ...
    setElementPlaneUniforms(e, t) {
      ...
      if (e.uniforms.mousePos) {
        ...
        if (t.mouseMomentum && t.type !== "mouse") {
          ...
          (r = J(r, l, t.mouseMomentum * 2)),
            (a = J(a, d, t.mouseMomentum * 2)),
    ...
    setEffectPlaneUniforms(e, t) {
      ...
      if (e.uniforms.mousePos) {
        ...
        if (t.mouseMomentum && t.type !== "mouse") {
          ...
          (r = J(r, h, t.mouseMomentum * 2)),
            (a = J(a, o, t.mouseMomentum * 2)),
            (t.local.lastMousePos.x = r / s),
            (t.local.lastMousePos.y = 1 - a / i);
        }
        (e.uniforms.mousePos.value.x = r / s),
    ...
    getTextureParams(e, t, s) {
      ...
      const r = e[t].userData.downSample ? 0.5 : 1,
        a = {
          ...
          depth:
            ((h = s == null ? void 0 : s.data) == null ? void 0 : h.depth) ||
    ...
    async removePlanes() {
      ...
      for (const t of e.static) {
        ...
        (s || i) && (await Ct(t, s ? "loaded" : "fullyLoaded"));
        const r = t.getPlanes();
  ...
  function Nt() {
    window.addEventListener("mousemove", ce),
      ...
      window.addEventListener("routeChange", Fe),
      document.addEventListener("mouseleave", Ue),
      Ce()
        ? window.addEventListener("orientationchange", le(de, 20))
        : window.addEventListener("resize", le(de, 200)),
      document.addEventListener(te, ke, !1),
      (ge = !0);
  }
  function ye() {
    window.removeEventListener("mousemove", ce),
      ...
      window.removeEventListener("routeChange", Fe),
      document.removeEventListener("mouseleave", Ue),
      window.removeEventListener("resize", le(de, 200)),
      window.removeEventListener("orientationchange", le(de, 20)),
      document.removeEventListener(te, ke, !1),
      (ge = !1);
  }
  function Ht(n, e, t) {
    return {
  ...
  function Ve(n) {
    ...
    return new Promise((s, i) => {
      jt(e, t, n.filePath, i, n.production)
        .then((r) => {
          r ||
            i(new Error(`Unable to fetch embed/file with id '${n.projectId}'`));
          const a = r.options || {},
            h = Wt(n.element)
              ? n.element
          ...
          n.altText && (d.curtain.canvas.innerText = n.altText),
            n.ariaLabel &&
              d.curtain.canvas.setAttribute("aria-label", n.ariaLabel),
            d.curtain.canvas.setAttribute("role", "img"),
            (a.freePlan || a.includeLogo) && Et(o, h),
            a.freePlan && console.log("Made with unicorn.studio"),
            b.scenes.push(d),
            (d.layers = l),
            (d.mouse.recordTrail = !!d.layers.find((c) => c.type == "mouse")),
            d.setInteractiveParams(n, a),
            (d.isInView = d.isFixed || De(d.element, d.bbox, 50)),
